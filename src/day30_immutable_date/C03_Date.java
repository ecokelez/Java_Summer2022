...
public class C03_Date {
    public static void main(String[] args) {
        ...
        LocalDate tarih3=LocalDate.of(1989, Month.JULY,23);
        System.out.println(tarih3); //  1989-07-23
        ...
        System.out.println(tarih.minusDays(5)); //  2022-07-18
        ...
        }else System.out.println("iki tarih biribiri ile aynı");
