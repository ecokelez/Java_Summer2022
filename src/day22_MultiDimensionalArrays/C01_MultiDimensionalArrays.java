...
public class C01_MultiDimensionalArrays {
    ...
    tek katli arraylerde array'i direk yazdiramiyoruz  cunku array non-primitive data turudur
     ve her non-primitive data direk yazdirilamayabilir
    ...
    public static void main(String[] args) {
        ...
        System.out.println(sayılar[0]);  //  [I@19dfb72a

        System.out.println(Arrays.toString(sayılar[0]));     //[1, 2, 3, 4]

        System.out.println(sayılar[0][1]);   // 2
        System.out.println(sayılar[1][0]); //  5

        System.out.println(Arrays.toString(sayılar));   // [[I@19dfb72a, [I@17c68925]

        System.out.println(Arrays.deepToString(sayılar));  //  [[1, 2, 3, 4], [5, 6]]
