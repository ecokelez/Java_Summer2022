...
public class Fp05 {
    public static void main(String[] args) {
        ...
        System.out.println("ortalamaPuanlarverilenSayıdanBuyukMu:"+ortalamaPuanlarverilenSayıdanBuyukMu(coursesList, 75));
        System.out.println(kelimeKursAdlarıIcindeVarMı(coursesList,"Turkish"));
        ortalamaPuanıEnYuksekKursAdı(coursesList);
        System.out.println(ortalamaPuanıEnYuksekKursAdı01(coursesList));
    ...
    public static boolean ortalamaPuanlarverilenSayıdanBuyukMu(List<Courses>list,double x){
    ...
    public static boolean kelimeKursAdlarıIcindeVarMı(List<Courses>list,String kelime){
    ...
    // 1.yol:
    public static void ortalamaPuanıEnYuksekKursAdı(List<Courses>list){
    ...
    //2 .yol:
    public static String ortalamaPuanıEnYuksekKursAdı01(List<Courses>list){
       return list.stream().
               sorted(Comparator.comparing(Courses::getAverageScore).reversed()).
